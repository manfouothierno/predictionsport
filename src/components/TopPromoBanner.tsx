                    ...
                    <div className="max-w-7xl mx-auto px-4 py-2">
                        <div className="flex items-center justify-between">
                            ...
                            <div className="flex items-center space-x-2">
                                ...
                                <div>
                                    <div className="text-sm font-semibold text-gray-900">Exclusive</div>
                                    <div className="text-sm font-semibold text-gray-900">offer</div>
                                </div>
                            </div>
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <div className="flex items-center space-x-1.5">
                                ...
                                <div className="text-xs">
                                    <div className="font-semibold text-gray-900 leading-tight">Exclusive</div>
                                    <div className="font-semibold text-gray-900 leading-tight">offer</div>
                                </div>
                            </div>
