...
export async function generateMetadata({ params }: LayoutProps): Promise<Metadata> {
    return {
        ...
        alternates: {
            canonical: `https://predictionsport.com/${params.lang}/predictions/tomorrow`,
            languages: {
                'en': 'https://predictionsport.com/en/predictions/tomorrow',
                'fr': 'https://predictionsport.com/fr/predictions/tomorrow',
                'de': 'https://predictionsport.com/de/predictions/tomorrow',
                'es': 'https://predictionsport.com/es/predictions/tomorrow',
            }
        },
        robots: {
            index: true,
