...
export async function generateMetadata({ params }: LayoutProps): Promise<Metadata> {
    return {
        title: {
            ...
            default: 'Football Analysis & Insights ',
        },
        ...
        alternates: {
            ...
            languages: {
                'en': 'https://predictionsport.com/en/blog',
                'fr': 'https://predictionsport.com/fr/blog',
                'de': 'https://predictionsport.com/de/blog',
                'es': 'https://predictionsport.com/es/blog',
            }
        },
        robots: {
            index: true,
