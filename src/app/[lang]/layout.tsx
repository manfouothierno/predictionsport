...
export const metadata: Metadata = {
  ...
  description:
    "Get expert football predictions, live scores, and betting tips. Daily match [match] and predictions for Premier League, La Liga, Champions League and more.",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "Get expert football predictions, live scores, and betting tips.",
    images: [
      {
        url: "/og-image.jpg",
        width: 1200,
